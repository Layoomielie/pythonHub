                    ...
                    for companysize in self.companysizedict:
                        for jobterm in self.jobtermdict:
                            for degree in self.degreedict:
                                ...
                                yield Request(self.dayurl.format(city=city,cotype=cotype,workyear=workyear,companysize=companysize,jobterm=jobterm,degree=degree),self.parse1,meta=dict)
