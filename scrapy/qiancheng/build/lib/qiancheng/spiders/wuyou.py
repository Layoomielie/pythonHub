...
class WuyouSpider(scrapy.Spider):
    ...
    citydict = {'010000': '北京', '020000': '上海', '030200': '广州', '040000': '深圳', '080200': '杭州','200200':'西安','070200':'南京','090200':'成都','060000':'重庆','070300':'苏州'}
                    ...
                    for companysize in self.companysizedict:
                        for jobterm in self.jobtermdict:
                            for degree in self.degreedict:
                                ...
                                yield Request(self.url.format(city=city,cotype=cotype,workyear=workyear,companysize=companysize,jobterm=jobterm,degree=degree),self.parse1,meta=dict)
